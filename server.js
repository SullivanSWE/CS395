...
// Store your actual password in an environment variable for security
const DB_PASSWORD = process.env.DB_PASSWORD || 'CS395Project'; // Replace with actual password in production
...
//Using Local Database. Replace Above Code With:
// const express = require('express');
// const mongoose = require('mongoose');
// const cors = require('cors');
// const app = express();
